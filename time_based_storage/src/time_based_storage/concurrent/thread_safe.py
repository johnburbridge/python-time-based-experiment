...
import threading
from ..core import TimeBasedStorage

T = TypeVar('T')

class ThreadSafeTimeBasedStorage(TimeBasedStorage[T], Generic[T]):
    """
    Thread-safe implementation of TimeBasedStorage using Python's threading module.
    This implementation provides safe concurrent access to the storage using read-write locks.
    """
